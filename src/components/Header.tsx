    ...
    return (
        <div className="flex-1 max-w-2xl">
            <div className="relative">
                ...
                <Button 
                    size="icon" 
                    className="cursor-pointer  absolute top-1/2 right-2 -translate-y-1/2 h-9 w-9 rounded-full bg-primary/90 hover:bg-primary"
...
const NotificationBell: FC = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="cursor-pointer relative h-10 w-10 p-0 text-black hover:bg-black/20">
