...
// ----------------------------------------------------------------------------
// COMPONENT 1: UserAuth - PHIÊN BẢN TỐI ƯU
// ----------------------------------------------------------------------------
            ...
            <div className="hidden lg:flex items-center justify-between h-20 gap-4">
                ...
                <div className="flex-1 max-w-2xl">
                    <div className="relative">
                        <Input placeholder="Bạn cần tìm gì?" className="h-12 text-base text-black pl-5 pr-12 rounded-full" />
                        <Button size="icon" className="absolute top-1/2 right-2 -translate-y-1/2 h-9 w-9 rounded-full bg-primary/90 hover:bg-primary">
